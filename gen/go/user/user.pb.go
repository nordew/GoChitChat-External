...
var file_user_user_proto_depIdxs = []int32{
	...
	5,  // 9: user.User.Delete:input_type -> user.DeleteUserRequest
	6,  // 10: user.User.Login:input_type -> user.LoginUserRequest
	8,  // 11: user.User.Refresh:input_type -> user.RefreshUserRequest
	10, // 12: user.User.ParseAccessToken:input_type -> user.ParseAccessTokenRequest
	1,  // 13: user.User.Create:output_type -> user.CreateUserResponse
	3,  // 14: user.User.Get:output_type -> user.GetUserResponse
	14, // 15: user.User.Update:output_type -> google.protobuf.Empty
	14, // 16: user.User.Delete:output_type -> google.protobuf.Empty
	7,  // 17: user.User.Login:output_type -> user.LoginUserResponse
	9,  // 18: user.User.Refresh:output_type -> user.RefreshUserResponse
	11, // 19: user.User.ParseAccessToken:output_type -> user.ParseAccessTokenResponse
